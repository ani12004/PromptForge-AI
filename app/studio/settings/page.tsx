                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="text-white font-medium flex items-center gap-2">
                                        GitHub
                                        {user?.externalAccounts.find(acc => acc.provider.includes("github")) && (
                                    ...
                                    <div className="text-sm text-gray-400">
                                        {user?.externalAccounts.find(acc => acc.provider.includes("github"))
                                            ? `Connected as @${user.externalAccounts.find(acc => acc.provider.includes("github"))?.username}`
                                            : "Connect your GitHub account"}
                                    </div>
                                </div>
                            </div>
                            <button className="px-4 py-2 rounded-lg bg-white/5 hover:bg-white/10 text-white transition-colors text-sm">
                                {user?.externalAccounts.find(acc => acc.provider.includes("github")) ? "Manage" : "Connect"}
                            </button>
                        </div>
                    </div>
                </section>
